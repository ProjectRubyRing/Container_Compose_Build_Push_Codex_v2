...
DATASOURCE_SUCCESS_LOG_PATTERN='WFLYJCA0001'
DATASOURCE_ERROR_LOG_PATTERN='(WFLYCTL0013|WFLYCTL0080).*(datasource|data source|java:/|jboss\.naming\.context\.java\.)|(IJ[0-9]{6}).*(datasource|data source|java:/)|(WFLYJCA[0-9]{4}).*(warning|warn|error|failed|failure|exception|unable)|(datasource|data source|java:/|jboss\.naming\.context\.java\.).*(warning|warn|error|failed|failure|exception|unable|missing|unavailable|not installed)'
...
DEPLOY_SUCCESS_LOG_PATTERN='WFLYSRV0010|WFLYDR0001|WFLYDS0010|deployed|deployment'
